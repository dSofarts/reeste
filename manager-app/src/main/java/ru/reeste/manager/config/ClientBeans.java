package ru.reeste.manager.config;
...
import ru.reeste.manager.clients.BudgetLineRestClientImpl;
import ru.reeste.manager.clients.BudgetRestClientImpl;
import ru.reeste.manager.security.OAuthClientHttpRequestInterceptor;
